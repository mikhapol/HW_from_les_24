...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        response = self.client.post('/app_users/token/', data={'email': self.user.email, 'password': 'qwerty'})
    ...
    def test_get_lessons_by_id(self):
        ...
        response = self.client.get(reverse('app_lesson:lesson', args=[self.lesson.pk]))
